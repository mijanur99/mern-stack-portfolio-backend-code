...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  // Log Cloudinary response and user data for debugging
  // console.log("Cloudinary Response for Avatar:", cloudinaryResponseForAvatar);
  // console.log("Cloudinary Response for Resume:", cloudinaryResponseForResume);
